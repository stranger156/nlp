...
from CNN_model import get_embedding_matrix, CNN_config, CNN_model
...
def predict(model, test_loader):
    ...
    df.to_csv('predict_result_cnn_embedding.csv', index=False)
    return
...
torch.save(model.state_dict(), 'cnn_model_embedding.pth')
